...
public class Server extends Thread {
    ...
    public boolean processTransactions(Transactions trans) {
        ...
        while ((!Network.getClientConnectionStatus().equals("disconnected"))) {
            ...
            // Only used when 2 server threads, fixes race conidition
            try {
                Thread.sleep(5);
    ...
    public double deposit(int i, double amount) {
        ...
        // this would only block for thread1, account[i] is shared
        ...
        // System.out.println("\n DEBUG : Server.deposit - " + "i " + i + " Current
    ...
    public double withdraw(int i, double amount) {
        ...
        // System.out.println("\n DEBUG : Server.withdraw - " + "i " + i + " Current
        // balance " + curBalance
    ...
    public double query(int i) {
        ...
        // System.out.println("\n DEBUG : Server.query - " + "i " + i + " Current
        // balance " + curBalance + " "
        // + getServerThreadId());
    ...
    public void run() {
        ...
        if (getServerThreadId().equals("Thread1")) {
            ...
            System.out.println("\n Terminating server thread - " + serverThreadId + " Running time "
        ...
        // System.out.println("\n Terminating server thread - " + serverThreadId + "
        // Running time "
        // + (serverEndTime - serverStartTime) + " milliseconds");
        // setServerThreadRunningStatus3("terminated");
        // }

        // if both terminated are terminated you can disconnect
